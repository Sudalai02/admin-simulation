  ...
  return (
    <nav className="flex justify-between items-center p-4 bg-white shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <Link to="/" className="text-sm text-gray-600">All Products</Link>
        <Link to="/admin/orders" className="text-sm text-gray-600">Admin</Link>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {!user ? (
          <button onClick={login} className="bg-blue-600 text-white px-3 py-1 rounded">Login with Google</button>
        ) : (
          <>
